    ...
    <div className="flex flex-col items-center px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col items-center justify-center h-[100vh] w-full max-w-md">
        <div className="mb-8 sm:mb-12 flex items-center flex-col gap-4 sm:gap-7">
          ...
          <p className="text-[1.5rem] sm:text-[2rem] text-[#0059AC]">Sign up</p>
        </div>
        ...
        <div className="flex gap-[0.25rem] items-center">
          <span className="font-normal text-sm sm:text-base">Already have an account?</span>
          <Link to={"/signin"}><span className="font-medium hover:underline text-sm sm:text-base">Sign in</span></Link>
        </div>
      </div>
    </div>
  );
